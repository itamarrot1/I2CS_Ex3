...
/******************************************************************************
 *  Compilation:  javac mygame.StdDraw.java
 *  Execution:    java mygame.StdDraw
 *  Dependencies: none
 *
 *
 ...
 */
/**
 *  The {@code mygame.StdDraw} class provides a basic capability for
 *  creating drawings with your programs. It uses a simple graphics model that
 ...
 *  <p>
 *  <b>Getting started.</b>
 *  To use this class, you must have {@code mygame.StdDraw.class} in your
 *  Java classpath. If you used our autoinstaller, you should be all set.
 *  Otherwise, either download
 *  <a href = "https://introcs.cs.princeton.edu/java/code/stdlib.jar">stdlib.jar</a>
 *  and add to your Java classpath or download
 *  <a href = "https://introcs.cs.princeton.edu/java/stdlib/StdDraw.java">mygame.StdDraw.java</a>
 ...
 *           mygame.StdDraw.setPenRadius(0.05);
 *           mygame.StdDraw.setPenColor(mygame.StdDraw.BLUE);
 *           mygame.StdDraw.point(0.5, 0.5);
 *           mygame.StdDraw.setPenColor(mygame.StdDraw.MAGENTA);
 *           mygame.StdDraw.line(0.2, 0.2, 0.8, 0.2);
 *       }
 *   }
 *  </pre>
 ...
 *  The methods {@code mygame.StdDraw.line()} and {@code mygame.StdDraw.point()}
 *  draw lines and points; the methods {@code mygame.StdDraw.setPenRadius()}
 *  and {@code mygame.StdDraw.setPenColor()} control the line thickness and color.
 *  <p>
 ...
 *  and represented in degrees. For example, {@code mygame.StdDraw.arc(0.0, 0.0, 1.0, 0, 90)}
 ...
 *   mygame.StdDraw.filledPolygon(x, y);
 *  </pre>
 *  <p>
 *  <b>Pen size.</b>
 ...
 *  </ul>
 *  <p>
 *  For example, {@code mygame.StdDraw.setPenRadius(0.025)} makes
 ...
 *  For example, {@code mygame.StdDraw.setPenColor(mygame.StdDraw.MAGENTA)} sets the
 ...
 *  For example, {@code mygame.StdDraw.setCanvasSize(800, 800)}
 ...
 *  leave a small margin, you can call {@code mygame.StdDraw.setScale(-.05, 1.05)}.
 *  <p>
 ...
 *   mygame.StdDraw.setFont(font);
 *   mygame.StdDraw.text(0.5, 0.5, "Hello, World");
 *  </pre>
 *  <p>
 *  <b>Images.</b>
 ...
 *  {@code mygame.StdDraw.clear(mygame.StdDraw.LIGHT_GRAY)} clears the canvas to a shade
 *  of gray.
 *  <p>
 ...
 *  <pre>
 *   mygame.StdDraw.setScale(-2, +2);
 *   mygame.StdDraw.enableDoubleBuffering();
 *
 *   for (double t = 0.0; true; t += 0.02) {
 *       double x = Math.sin(t);
 *       double y = Math.cos(t);
 *       mygame.StdDraw.clear();
 *       mygame.StdDraw.filledCircle(x, y, 0.05);
 *       mygame.StdDraw.filledCircle(-x, -y, 0.05);
 *       mygame.StdDraw.show();
 *       mygame.StdDraw.pause(20);
 *   }
 *  </pre>
 *  <p>
...
public final class StdDraw implements ActionListener, MouseListener, MouseMotionListener, KeyListener {
	 ...
	 * {@code mygame.StdDraw.BLACK}, {@code mygame.StdDraw.BLUE}, {@code mygame.StdDraw.CYAN},
	 * {@code mygame.StdDraw.DARK_GRAY}, {@code mygame.StdDraw.GRAY}, {@code mygame.StdDraw.GREEN},
	 * {@code mygame.StdDraw.LIGHT_GRAY}, {@code mygame.StdDraw.MAGENTA}, {@code mygame.StdDraw.ORANGE},
	 * {@code mygame.StdDraw.PINK}, {@code mygame.StdDraw.RED}, {@code mygame.StdDraw.WHITE}, and
	 * {@code mygame.StdDraw.YELLOW}.
	 *
	...
	private static Image getImage(String filename) {
		...
		// in case file is inside a .jar (classpath relative to mygame.StdDraw)
		if ((icon == null) || (icon.getImageLoadStatus() != MediaTracker.COMPLETE)) {
    ...
    private static BufferedImage getImage(String filename) {
        ...
        // in case file is inside a .jar (classpath relative to mygame.StdDraw)
        try {
            URL url = mygame.StdDraw.class.getResource(filename);
            BufferedImage image = ImageIO.read(url);
            return image;
        } 
        catch (IOException e) {
	...
	public void mousePressed(MouseEvent e) {
		...
		//mygame.StdDraw.ellipse(0.3, 0.5, 0.1, 0.2);
		//mygame.StdDraw.clear();
		StdDraw.draw();
	}
